...
## 是否需要：Flying before Walking - 即：
      1. 你开始学习知识（看一本书）之前，是否要先最快速的把书翻一遍，看看该书是否值得学习，如果不是，是否，部分值得作为掌握该知识的学习书籍，如果是，是哪部分值得。。。 特别说明：爸爸学习知识，都不一定，只看一本书，作为 计算机专业，这一点，爸爸认为很重要。-- 一定要取不同书籍之长。。。
         - 这篇文档，就是通过浏览，大量的书籍，做的规划，组织，形成的学习脉络。。，然后，就大致知道那部分知识，通过哪本书进行 深入 的学习，
